...
public class EditText extends Label {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString((editText.length() == 0 && getIsFocus()) ? defaultText : editText, super.getX()+7, super.getY() + super.height() / 2 + g.getFontMetrics().getDescent());
        ...
        if (super.getIsFocus() && isEditable) {
            ...
            if (isCursorLight) {
                ...
                g.fillRect(super.getX() + 8 + stringWidth, super.getY() + super.height() / 2 - (cursorHeight + g.getFontMetrics().getDescent()) / 2, cursorWidth, cursorHeight);
            }
        }
    }
